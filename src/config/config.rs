...
pub struct StorageConfig {
    ...
    #[clap(long = "storage-fs-root", value_name = "VALUE", default_value_t)]
...
pub struct MemoryCacheConfig {
    /// The capacity of memory cache in blocks, default is 16384 blocks.
    #[clap(
...
mod tests {
    ...
    fn test_basic_config() {
        ...
        assert_eq!(memory_cache_config.capacity, 0x4000);
